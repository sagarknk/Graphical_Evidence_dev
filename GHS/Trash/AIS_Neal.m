...
parfor neal_iter = 1:25
    ...
    [init_Omega, ~, tau_sq_samples] = prior_sampling(q,100,100,lambda,neal_iter);
    init_tau_sq_sample = tau_sq_samples(:,:,100);
    
    try
        for sample_index = 1:N
            
            [omega_sample,tau_sq_sample] = prior_sampling_for_Neal_and_Skilling(q,lambda,init_Omega,...
                init_tau_sq_sample);
            ...
            for density_seq = 2:T
                ...
                %%% Proposal again from GHS
                
                [omega_proposed,tau_sq_proposed] = prior_sampling_for_Neal_and_Skilling(q,lambda,omega_sample,...
                    tau_sq_sample);
