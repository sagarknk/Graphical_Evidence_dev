    ...
    for num_GHS = 1:q %%% consider num_GHS equivalent to index j in the paper
        ...
        if num_GHS<= q-1
            ...
            [post_mean_omega,post_mean_tau_save, MC_average_Equation_9] = ...
                GHS_Hao_wang(S_reduced,n,burnin,nmc,lambda, Matrix_2be_added_Gibbs);
            ...
            [post_mean_omega_22_2ndGibbs, MC_average_Equation_11] = ...
                GHS_last_col_fixed(S_reduced,n,burnin, nmc,lambda, fixed_last_col, ...
            ...
            for i = 1:nmc
                omega_save_direct(:,:,i) = gamrnd(n/2 + 1, 2/(1/lambda + S_reduced));
            end
